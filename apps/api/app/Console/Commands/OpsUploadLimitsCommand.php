...
class OpsUploadLimitsCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $ok = $this->normalizeIniSize($uploadMax) >= $this->normalizeIniSize($expected['upload_max_filesize'])
        ...
        $payload = [
            ...
            'actual_php' => $actual,
            'verify_shell' => 'php -i | grep -E "upload_max_filesize|post_max_size|memory_limit"',
        ];
