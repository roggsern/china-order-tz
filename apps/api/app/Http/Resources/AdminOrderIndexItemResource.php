...
class AdminOrderIndexItemResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        $imageSnapshot = $this->product_image_snapshot ?? $this->image_snapshot;
        ...
        return [
            ...
            'estimated_min_days_snapshot' => $this->estimated_min_days_snapshot,
            'estimated_max_days_snapshot' => $this->estimated_max_days_snapshot,
