  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
      ...
      {notFound ? (
        ...
        >
          <EmptyState
            icon={<PackageThumbnailIcon className="h-8 w-8 text-[#8b6914]" />}
            title="No order found"
            description="We couldn’t match that ID. Check your confirmation email or order success page, then try again."
